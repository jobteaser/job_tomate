require 'spec_helper'
require 'job_tomate/workflows/jira/rules/comments'
require 'job_tomate/commands/slack/send_message'

describe JobTomate::Workflows::Jira::Rules::Comments do
        ...
        context 'with mentioned user in body' do
          ...
          context 'mentioned user exist in JobTomate\'s DB' do
            ...
            context 'has Slack username' do
              it 'sends a notification to the mentioned user on Slack' do
                expect(JobTomate::Commands::Slack::SendMessage).to receive(:run) do |message, options|
          ...
          context 'mentioned several users found in JobTomate\'s DB' do
            ...
            it 'notifies all users' do
              expect(JobTomate::Commands::Slack::SendMessage).to receive(:run).twice
              subject
            end
          end
        end
